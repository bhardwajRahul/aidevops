...
# worker to tier:thinking. No recommendation to switch to no-auto-dispatch —
...
_warn_dispatch_path_auto_dispatch() {
	...
	log_info "  The pre-dispatch detector (t2819) will auto-elevate this worker to tier:thinking."
